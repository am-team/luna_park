...
Я хотел бы рассказать об опыте применения практик DDD к существующему Ruby on Rails 
проекту. Изначально, мы имели монолит, который писался 10 лет. Основная трудность проекта была
...
![Alt text](../imgs/graph_1.png?raw=true "Типичный проект")
...
![Alt text](../imgs/graph_2.jpg?raw=true&height=250x "Высокосвязанный проеект" )
...
![Alt text](../imgs/graph_3.png?raw=true&height=250x "Деньги")
...
![Alt text](../imgs/graph_4.jpg?raw=true&height=250x "Низкосвязанный проеект" )
...
![Alt text](../imgs/graph_5.png?raw=true&height=250x "Сегметированный проект" )
...
В следующий раз я хотел бы рассмотреть более подробно суть DDD подхода и его микросервисной реализации. В
данной статье я просто подчеркиваю, что эти методологии не являются серебрянной пулей. 
